		...
		if (obj == tfInput || obj == btnInput) {
			...
			try {
				...
				if (1 > userNum || userNum > 100) {
					//taMessage.append("1~100사이의 숫자를 입력해주세요.")
					JOptionPane.showMessageDialog(GuessNumFrame.this, "1~100사이의 숫자를 입력해주세요.", "알림", JOptionPane.ERROR_MESSAGE);
					tfInput.setText("");
				...
				//taMessage.append("숫자를 입력해주세요.")
				JOptionPane.showMessageDialog(GuessNumFrame.this, "숫자만 입력해주세요", "알림", JOptionPane.ERROR_MESSAGE);
				tfInput.setText("");
				return;
				}
				int count = manager.getCount();
